...
public class Node {
	...
	private void calcMaxPath() {
		int lNr = left != null ? left.getMaxPath() : Integer.MIN_VALUE;
		int rNr = right != null ? right.getMaxPath() : Integer.MIN_VALUE;
	...
	private void calcMinPath() {
		int lNr = left != null ? left.getMinPath() : Integer.MAX_VALUE;
		int rNr = right != null ? right.getMinPath() : Integer.MAX_VALUE;
