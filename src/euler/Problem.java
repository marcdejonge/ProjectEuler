...
public abstract class Problem<T> {
    ...
    static {
        ...
        knownSolutions.put(93, Number.valueOf(1258));
        ...
        knownSolutions.put(98, Number.valueOf(18769));
        knownSolutions.put(99, Number.valueOf(709));
        knownSolutions.put(100, Number.valueOf(756872327473l));
        knownSolutions.put(101, Number.valueOf(37076114526l));
        knownSolutions.put(102, Number.valueOf(228));
        knownSolutions.put(103, Number.valueOf(20313839404245l));
        ...
        knownSolutions.put(118, Number.valueOf(44680));
        ...
        knownSolutions.put(122, Number.valueOf(1582));
        ...
        knownSolutions.put(126, Number.valueOf(18522));
        knownSolutions.put(127, Number.valueOf(18407904));
        knownSolutions.put(128, Number.valueOf(14516824220L));
        knownSolutions.put(129, Number.valueOf(1000023));
        knownSolutions.put(130, Number.valueOf(149253));
        knownSolutions.put(142, Number.valueOf(1006193));
        knownSolutions.put(145, Number.valueOf(608720));
        ...
        knownSolutions.put(187, Number.valueOf(17427258));
