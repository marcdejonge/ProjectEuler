...
public class DecreasingNumbers extends AbstractSequence implements SortedLongSequence {
    private final LongSortedSet numbers;
    private int factor;
    private int position;

    public DecreasingNumbers() {
    ...
    @Override
    public DecreasingNumbers reset() {
        position = 0;
        return this;
    }
}
